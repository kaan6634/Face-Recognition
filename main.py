...
person1_image = face_recognition.load_image_file("person1.png")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

person2_image = face_recognition.load_image_file("person2.png")
person2_face_encoding = face_recognition.face_encodings(person2_image)[0]

person3_image = face_recognition.load_image_file("person3.png")
person3_face_encoding = face_recognition.face_encodings(person3_image)[0]

person4_image = face_recognition.load_image_file("person4.png")
